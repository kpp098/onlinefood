...
<html>
  ...
  <head>
    <title> Online Payment |FoodXpress </title>
  </head>
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="row ">
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                             <a href="payment.php"><input type="submit" class="btn btn-danger btn-block" value="CANCEL"  /></a>   
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6 pad-adjust">
                              <a href="COD.php"><input type="submit" class="btn btn-success btn-block" value="PAY NOW"  /></a>  
                            </div>
                        </div>
