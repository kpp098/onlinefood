      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          <ul class="nav navbar-nav">
            <li class="active" ><a href="foodlist.php">Home</a></li>
...
?>
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo"></div><br>
        <div class="col-xs-5 line"><hr></div>
        <div  data-text="Good Food is Good Mood" class="tagline">Good Food is Good Mood</div>
    </div>
    <br>
    <div class="orderblock">
    <h2>Feeling Hungry?</h2>
    <center><a class="btn btn-success btn-lg" href="customerlogin.php" role="button" >  Sign In To Order Now </a></center>
    </div>
